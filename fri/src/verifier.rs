...
impl<'a, G, Val, Challenge, M, Challenger> LdtVerifer<'a, G, Val, Challenge, M, Challenger>
    for Verifier<'a, G, Val, Challenge, M, Challenger>
where
    Val: Field,
    Challenge: ExtensionField<Val>,
    M: Mmcs<Challenge>,
    ...
    G: FriGenericConfig<Challenge>,
{
    ...
    for qp in &proof.query_proofs {
        ...
        if folded_eval != proof.final_poly {
            return Err(FriError::FinalPolyMismatch.into());
        }
    }
